function declineTOS(){localStorage.setItem("agreed-to-tos",!1),window.location.replace(window.$scope.tos.config.forward_url)}function acceptTOS(){localStorage.setItem("agreed-to-tos",!0)}window.$scope={},window.$scope.tos={};
